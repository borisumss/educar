...
public class GuardarArchivo {
    ...
    public void guardarArchivo(ConectarBD con2, File archivoSeleccionado,String nombreMateria,int grupo,String nombreEstudiante,int codSis){
        this.con = con2;
            ...
            if (archivoSeleccionado != null){
                if(archivoSeleccionado.getName().contains(".pdf") || archivoSeleccionado.getName().contains(".zip") || archivoSeleccionado.getName().contains(".docx")){
                    if((((float)archivoSeleccionado.length()/1024)/1024) <= 50.0f){
                        ...
                        try{
                            PreparedStatement subirTrabajo = con2.prepareStatement(subirArchivo);
    ...
    public void consultaEstudiante(String nombreEstudiante,int codSis,String nombreMateria,int grupo){
        try{
            PreparedStatement consulta = this.con.prepareStatement(buscarEstudianteMatriculado);
